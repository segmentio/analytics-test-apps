---
This is a sample integration of Segment into an application.  Will be used for testing and modification.  Pod is setup such that analytics-ios pod is a submodule.
---
